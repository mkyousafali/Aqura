-- ============================================================================
-- Helper function for Edge Function to get overdue tasks
-- ============================================================================

-- Drop existing function first
DROP FUNCTION IF EXISTS get_overdue_tasks_without_reminders();

-- Recreate with correct types
CREATE OR REPLACE FUNCTION get_overdue_tasks_without_reminders()
RETURNS TABLE (
  assignment_id UUID,
  task_id UUID,
  task_title TEXT,
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION get_overdue_tasks_without_reminders() TO service_role;
GRANT EXECUTE ON FUNCTION get_overdue_tasks_without_reminders() TO authenticated;

COMMENT ON FUNCTION get_overdue_tasks_without_reminders() IS 'Returns overdue tasks that havent received reminders yet - used by Edge Function';
