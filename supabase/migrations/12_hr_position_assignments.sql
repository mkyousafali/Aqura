-- Migration: Create hr_position_assignments table
-- File: 12_hr_position_assignments.sql
-- Description: Creates the hr_position_assignments table for managing employee position assignments
