...
async function checkOfferProductsStructure() {
  console.log('🔍 Checking offer_products table structure...\n');
  ...
  console.log(`📊 Table: offer_products`);
