...
│   │   │   │   ├── admin/     # Admin components (tasks, vendor, receiving, etc.)
│   │   │   │   │   └── coupon/
...
│   │   │   │   │           └── CouponRedemption.svelte  # Redemption window component
...
│   │   │   ├── coupon/
│   │   │   │   └── cashier/   # Cashier access code login route
│   │   │   └── +page.svelte   # Desktop windowed interface
