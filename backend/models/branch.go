...
type Branch struct {
	...
	VatNumber             sql.NullString `json:"vat_number,omitempty" db:"vat_number"`
	...
	DeliveryMessageAr     sql.NullString `json:"delivery_message_ar,omitempty" db:"delivery_message_ar"`
	DeliveryMessageEn     sql.NullString `json:"delivery_message_en,omitempty" db:"delivery_message_en"`
