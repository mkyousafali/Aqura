-- Migration: Fix receiving task user ID type conversions
-- File: 80_fix_receiving_task_user_id_types.sql
-- Description: Removes ::text conversions from process_clearance_certificate_generation function to fix UUID type mismatch error
-- This allows the function to work with both TEXT (pre-migration-78) and UUID (post-migration-78) column types
...
-- Recreate function without ::text conversions
...
Deadline: %s (24 hours)', 
                ...
                -- Create task (without ::text conversion)
                INSERT INTO tasks (
                    title,
                    description,
                    created_by,
                ...
                -- Create task assignment with deadline columns (without ::text conversion)
...
Task Details: %s', 
                ...
                -- Create notification (without ::text conversion)
