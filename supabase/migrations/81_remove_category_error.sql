-- Migration 81: Remove category column error from create_task function
-- Simple fix to remove the non-existent category column reference
...
-- Update generate_clearance_certificate_tasks to use simplified create_task
