CREATE OR REPLACE FUNCTION public.get_near_expiry_reports(
...
GRANT EXECUTE ON FUNCTION public.get_near_expiry_reports(INT, INT, TEXT, TEXT, DATE, DATE) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_near_expiry_reports(INT, INT, TEXT, TEXT, DATE, DATE) TO anon;
