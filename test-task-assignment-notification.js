/**
 * Test script to validate task assignment notification creation
 */
...
async function testNotificationCreation() {
    ...
    try {
        ...
        const testNotification = {
            ...
            message: 'This is a test task assignment notification with deadline: 1/20/2025\n\nNotes: Please complete this test task promptly\n📷 Photo upload required',
            type: 'task_assigned',
            priority: 'medium',
            target_type: 'specific_users',
            target_users: JSON.stringify(['test-user-id-1', 'test-user-id-2']),
