...
--
-- Name: TABLE buckets; Type: COMMENT; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow anon delete from custom-fonts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow anon insert offer-pdfs; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow anon upload to custom-fonts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated delete from custom-fonts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated upload to custom-fonts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to delete from pos-before; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to read files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to read pos-before; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to update files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to upload files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow authenticated users to upload to pos-before; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow delete for asset invoices; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow delete for stock documents; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow delete on product-request-photos; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow public read access on product-request-photos; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow public read access to custom-fonts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow update for asset invoices; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow update for stock documents; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow update on product-request-photos; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow upload for asset invoices; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow upload for stock documents; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Allow upload on product-request-photos; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Anyone can read frontend builds; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated delete from app-icons; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated update app-icons; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated upload to app-icons; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated users can read receipts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated users can upload frontend builds; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Authenticated users can upload receipts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Enable all access to offer-pdfs; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Enable all access to offer-pdfs" ON storage.objects USING ((bucket_id = 'offer-pdfs'::text)) WITH CHECK ((bucket_id = 'offer-pdfs'::text));


--
-- Name: objects Public can view receipts; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Public read access for app-icons; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Public read access for asset invoices; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Public read access for stock documents; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Public read whatsapp media; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects Service role has full access to files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Service role has full access to files" ON storage.objects USING (((bucket_id = 'offer-pdfs'::text) AND true)) WITH CHECK (((bucket_id = 'offer-pdfs'::text) AND true));


--
-- Name: objects Service role manage frontend builds; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Service role manage frontend builds" ON storage.objects TO service_role USING ((bucket_id = 'frontend-builds'::text)) WITH CHECK ((bucket_id = 'frontend-builds'::text));


--
-- Name: objects Service upload whatsapp media; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_all_operations for files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "allow_all_operations for files" ON storage.objects USING (((bucket_id = 'offer-pdfs'::text) AND true)) WITH CHECK (((bucket_id = 'offer-pdfs'::text) AND true));
...
CREATE POLICY allow_all_storage ON storage.objects USING (true) WITH CHECK (true);


--
-- Name: objects allow_delete; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_delete files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_insert; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_select; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_select files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_update; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects allow_update files; Type: POLICY; Schema: storage; Owner: -
--
...
--
-- Name: objects anon_full_access files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "anon_full_access files" ON storage.objects USING (((bucket_id = 'offer-pdfs'::text) AND ((auth.jwt() ->> 'role'::text) = 'anon'::text)));


--
-- Name: objects authenticated_full_access files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "authenticated_full_access files" ON storage.objects USING (((bucket_id = 'offer-pdfs'::text) AND (auth.uid() IS NOT NULL)));
...
GRANT SELECT ON TABLE storage.buckets TO replication_user;
...
GRANT SELECT ON TABLE storage.buckets_analytics TO replication_user;
...
GRANT SELECT ON TABLE storage.buckets_vectors TO replication_user;
...
GRANT SELECT ON TABLE storage.iceberg_namespaces TO replication_user;
...
GRANT SELECT ON TABLE storage.iceberg_tables TO replication_user;
...
GRANT SELECT ON TABLE storage.migrations TO replication_user;
...
GRANT SELECT ON TABLE storage.objects TO replication_user;
...
GRANT SELECT ON TABLE storage.prefixes TO replication_user;
...
GRANT SELECT ON TABLE storage.s3_multipart_uploads TO replication_user;
...
GRANT SELECT ON TABLE storage.s3_multipart_uploads_parts TO replication_user;
...
GRANT SELECT ON TABLE storage.vector_indexes TO replication_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA storage GRANT SELECT ON TABLES  TO replication_user;
