-- Migration for table: recurring_schedule_check_log
-- Generated on: 2025-10-30T21:55:45.323Z
...
CREATE TRIGGER set_recurring_schedule_check_log_updated_at
    BEFORE UPDATE ON public.recurring_schedule_check_log
    FOR EACH ROW
