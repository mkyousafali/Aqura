...
-- This table manages granular permissions for roles across application functions
...
CREATE TRIGGER update_role_permissions_updated_at BEFORE UPDATE ON role_permissions FOR EACH ROW
