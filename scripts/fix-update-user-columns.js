...
console.log('🔧 Creating correct update_user function with actual columns...\n');
...
-- Create function with ACTUAL columns from users table
CREATE OR REPLACE FUNCTION update_user(
  ...
  AS $$
  BEGIN
    -- Update only the columns that exist in the users table
    UPDATE users
    SET
      ...
      avatar = COALESCE((p_updates->>'avatar')::text, avatar),
...
console.log('\n✅ Updated to match actual users table columns!');
