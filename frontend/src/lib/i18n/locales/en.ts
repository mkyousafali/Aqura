  ...
  translations: {
    ...
    hr: {
      ...
      processFingerprint: {
        ...
        total_unapproved_days_off: "Total unapproved days off",
        ...
        status_unapproved_day_off: "Unapproved Day Off",
      ...
      shift: {
        ...
        mobile_day_off_request: {
          ...
          selectReason: "Please select a day-off reason",
          ...
          successMessage: "Day-off request submitted for {days} day{plural}!",
          failedToSubmit: "Failed to submit request",
          failedToLoadReasons: "Failed to load day-off reasons",
