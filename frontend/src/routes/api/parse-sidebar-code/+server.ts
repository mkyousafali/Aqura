	...
	try {
		...
		const structure = {
			...
			MEDIA: {
				...
				OPERATIONS: ['OFFER_PRODUCT_EDITOR', 'CREATE_NEW_OFFER', 'PRICING_MANAGER', 'GENERATE_FLYERS', 'SHELF_PAPER_MANAGER'],
				REPORTS: []
			},
			PROMO: {
			...
			FINANCE: {
				...
				OPERATIONS: ['MANUAL_SCHEDULING', 'DAY_BUDGET_PLANNER', 'MONTHLY_MANAGER', 'EXPENSE_MANAGER', 'PAID_MANAGER', 'DENOMINATION'],
				REPORTS: ['EXPENSE_TRACKER', 'SALES_REPORT', 'MONTHLY_BREAKDOWN', 'OVERDUES_REPORT', 'VENDOR_PAYMENTS']
			},
			HR: {
				DASHBOARD: [],
				MANAGE: ['UPLOAD_EMPLOYEES', 'CREATE_DEPARTMENT', 'CREATE_LEVEL', 'CREATE_POSITION', 'REPORTING_MAP', 'ASSIGN_POSITIONS', 'CONTACT_MANAGEMENT', 'DOCUMENT_MANAGEMENT', 'SALARY_WAGE_MANAGEMENT', 'WARNING_MASTER'],
				OPERATIONS: [],
