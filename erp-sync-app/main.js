...
// import Database from 'better-sqlite3'; // Disabled - requires Python to build
...
function initLocalDB() {
  try {
    ...
    console.log('⚠️  Offline mode unavailable (better-sqlite3 requires Python to build)');
    localDB = null;
    ...
    console.log('⚠️  Offline mode unavailable');
    localDB = null;
  }
}
