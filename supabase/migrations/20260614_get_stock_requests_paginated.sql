CREATE OR REPLACE FUNCTION public.get_stock_requests_with_details(
...
GRANT EXECUTE ON FUNCTION public.get_stock_requests_with_details(INT, INT, TEXT, TEXT, DATE, DATE) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_stock_requests_with_details(INT, INT, TEXT, TEXT, DATE, DATE) TO anon;
