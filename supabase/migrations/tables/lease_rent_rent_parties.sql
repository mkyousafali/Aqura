--
-- Name: lease_rent_rent_parties; Type: TABLE; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties lease_rent_rent_parties_pkey; Type: CONSTRAINT; Schema: public;
--
...
--
-- Name: idx_lrrp_collection_incharge; Type: INDEX; Schema: public;
--
...
--
-- Name: idx_lrrp_contract_dates; Type: INDEX; Schema: public;
--
...
--
-- Name: idx_lrrp_payment_mode; Type: INDEX; Schema: public;
--
...
--
-- Name: idx_lrrp_property_id; Type: INDEX; Schema: public;
--
...
--
-- Name: idx_lrrp_property_space_id; Type: INDEX; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties lease_rent_rent_parties_timestamp_update; Type: TRIGGER; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties lease_rent_rent_parties_created_by_fkey; Type: FK CONSTRAINT; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties lease_rent_rent_parties_property_id_fkey; Type: FK CONSTRAINT; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties lease_rent_rent_parties_property_space_id_fkey; Type: FK CONSTRAINT; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties Allow all access to lease_rent_rent_parties; Type: POLICY; Schema: public;
--
...
--
-- Name: lease_rent_rent_parties; Type: ROW SECURITY; Schema: public;
--
