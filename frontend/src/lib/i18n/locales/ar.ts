...
export const arabicLocale: LocaleData = {
  ...
  translations: {
    ...
    nav: {
      ...
      shiftAndDayOff: "المناوبات وأيام الإجازة",
    ...
    hr: {
      ...
      salary: {
        ...
        shiftAndDayOff: "الوردية وأيام الراحة",
      ...
      shift: {
        ...
        tabs: {
          ...
          day_off_date: "يوم الراحة (حسب التاريخ)",
          day_off_weekday: "يوم الراحة (حسب يوم الأسبوع)",
        },
        ...
        loading_day_off_date_data: "جاري تحميل بيانات يوم الراحة (التاريخ)...",
        loading_day_off_weekday_data: "جاري تحميل بيانات يوم الراحة (يوم الأسبوع)...",
        ...
        no_day_offs: "لم يتم العثور على أيام راحة",
        ...
        click_to_assign_recurring: "انقر لتعيين أيام راحة متكررة",
        click_to_assign_date: "انقر لتعيين أيام راحة لتاريخ محدد",
        ...
        add_day_off_date: "إضافة يوم راحة (حسب التاريخ)",
        add_day_off_weekday: "إضافة يوم راحة (حسب يوم الأسبوع)",
        shift_weekday: "يوم الوردية",
        shift_date: "تاريخ الوردية",
        day_off_date: "تاريخ يوم الراحة",
        day_off_weekday: "يوم الراحة",
        delete_shift_tooltip: "حذف هذه الوردية",
        delete_day_off_tooltip: "حذف يوم الراحة هذا",
        ...
        loading_day_off_data: "جاري تحميل بيانات أيام الراحة...",
        ...
        assign_day_off_date: "تعيين يوم راحة (حسب التاريخ)",
        assign_day_off_weekday: "تعيين يوم راحة (حسب يوم الأسبوع)",
        ...
        choose_employee_day_off: "اختر موظفًا لتعيين يوم راحة",
        choose_employee_recurring_day_off: "اختر موظفًا لتعيين يوم راحة متكرر",
        no_employees_found: "لم يتم العثور على موظفين",
        official_day_off: "يوم راحة رسمي",
        day_off: "يوم راحة",
        ...
        confirm_delete_day_off: "هل أنت متأكد من حذف يوم الراحة هذا؟",
        error_failed_delete: "فشل الحذف: ",
        error_failed_save: "فشل حفظ بيانات الوردية: ",
        error_failed_save_day_off: "فشل حفظ يوم الراحة: ",
        ...
        mobile_day_off_request: {
          ...
          selectReason: "يرجى اختيار سبب يوم الراحة",
          ...
          successMessage: "تم تقديم طلب يوم الراحة لـ {days} يوم{plural}!",
          failedToSubmit: "فشل في تقديم الطلب",
          failedToLoadReasons: "فشل في تحميل أسباب يوم الراحة",
