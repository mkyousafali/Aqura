--
-- Name: expense_sub_categories; Type: TABLE; Schema: public;
--
...
--
-- Name: expense_sub_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public;
--
...
--
-- Name: expense_sub_categories id; Type: DEFAULT; Schema: public;
--
...
--
-- Name: expense_sub_categories expense_sub_categories_pkey; Type: CONSTRAINT; Schema: public;
--
...
--
-- Name: idx_expense_sub_categories_is_active; Type: INDEX; Schema: public;
--
...
--
-- Name: idx_expense_sub_categories_parent; Type: INDEX; Schema: public;
--
...
--
-- Name: expense_sub_categories expense_sub_categories_parent_category_id_fkey; Type: FK CONSTRAINT; Schema: public;
--
...
--
-- Name: expense_sub_categories Allow admin users to delete sub categories; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories Allow admin users to insert sub categories; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories Allow admin users to update sub categories; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories Allow anon insert expense_sub_categories; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories Allow authenticated users to read sub categories; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories allow_all_operations; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories allow_delete; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories allow_insert; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories allow_select; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories allow_update; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories anon_full_access; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories authenticated_full_access; Type: POLICY; Schema: public;
--
...
--
-- Name: expense_sub_categories; Type: ROW SECURITY; Schema: public;
--
