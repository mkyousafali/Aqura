...
const structure: Record<string, Record<string, string[]>> = {
	...
	FINANCE: {
		DASHBOARD: ['APPROVAL_CENTER', 'LC_PLANNER', 'ERP_LEDGERS'],
		...
		REPORTS: ['EXPENSE_TRACKER', 'SALES_REPORT', 'SALES_ANALYSIS', 'MONTHLY_BREAKDOWN', 'OVERDUES_REPORT', 'VENDOR_PAYMENTS', 'POS_REPORT']
	},
	HR: {
		DASHBOARD: ['SECURITY_CODE', 'FINGERPRINT_DASHBOARD', 'QUICK_DASHBOARD'],
		MANAGE: ['EMPLOYEE_MASTER', 'LINK_ID', 'HR_SERVICES', 'SALARY_STATEMENT'],
	...
	CONTROLS: {
		DASHBOARD: ['APP_PERMISSIONS'],
		MANAGE: ['E_R_P_CONNECTIONS', 'CLEAR_TABLES', 'AI_CHAT_GUIDE', 'STORAGE_MANAGER', 'ICON_MANAGER', 'API_KEYS_MANAGER', 'SUPABASE_SECRETS', 'SUPPORT_APP_ACCESS'],
		OPERATIONS: ['PUSH_NOTIFICATION_SETTINGS', 'LOCAL_UPDATE'],
		REPORTS: ['PC_LOCK_GUARD']
	},
	SYSTEM: {
		DASHBOARD: [],
