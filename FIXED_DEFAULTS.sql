-- FIXED: Correct parameter defaults for create_task function
-- All parameters after one with a default must also have defaults

-- First, create the missing create_task function with proper defaults
