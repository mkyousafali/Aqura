...
<div class="mobile-notification-detail">
	...
	<header class="notification-header">
		<button class="back-btn" on:click={() => goto('/mobile/notifications')} aria-label="Go back to notifications">
	...
	<div class="notification-content">
		...
		{:else if errorMessage}
			<div class="error-state">
				...
				<h3>Error</h3>
				<p>{errorMessage}</p>
				<button class="retry-btn" on:click={() => goto('/mobile/notifications')}>
		...
		{:else}
			<div class="empty-state">
				...
				<button class="back-btn-large" on:click={() => goto('/mobile/notifications')}>
					Back to Notifications
				</button>
			</div>
		{/if}
