-- Migration: Create employee_warning_history table
-- File: 4_employee_warning_history.sql
-- Description: Creates the employee_warning_history table for tracking changes to employee warnings
