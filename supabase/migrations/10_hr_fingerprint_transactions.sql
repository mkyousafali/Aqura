-- Migration: Create hr_fingerprint_transactions table
-- File: 10_hr_fingerprint_transactions.sql
-- Description: Creates the hr_fingerprint_transactions table for managing employee fingerprint attendance records
