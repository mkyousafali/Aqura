...
-- This table manages task assignments with comprehensive scheduling and tracking features
...
OR UPDATE OF deadline_date, deadline_time ON task_assignments FOR EACH ROW
