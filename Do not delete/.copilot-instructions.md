...
1. **Before committing any changes**, run the version update script:
   ...
   - Increment version (2.0.2 → 2.0.3)
   - Update root `package.json`
   - Update `frontend/package.json`
   - Update version display in `frontend/src/lib/components/desktop-interface/common/Sidebar.svelte`
   - Update mobile version in `frontend/src/routes/mobile-interface/+layout.svelte`

2. **Update version popup content manually** (REQUIRED):
   - Edit `frontend/src/lib/components/desktop-interface/common/Sidebar.svelte` (lines ~610-650)
...
- `frontend/src/routes/mobile-interface/+layout.svelte` - Mobile top bar version badge
