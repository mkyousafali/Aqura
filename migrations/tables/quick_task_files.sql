-- Migration for table: quick_task_files
-- Generated on: 2025-10-30T21:55:45.321Z
...
CREATE TRIGGER set_quick_task_files_updated_at
    BEFORE UPDATE ON public.quick_task_files
    FOR EACH ROW
