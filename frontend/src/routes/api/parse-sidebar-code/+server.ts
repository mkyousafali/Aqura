	...
	try {
		...
		const structure = {
			...
			HR: {
				...
				OPERATIONS: ['EMPLOYEE_FILES', 'FINGERPRINT_TRANSACTIONS', 'PROCESS_FINGERPRINT', 'SALARY_AND_WAGE', 'SHIFT_AND_DAY_OFF', 'LEAVES_AND_VACATIONS', 'DISCIPLINARY_CONTROL'],
		...
		const buttonNames: Record<string, string> = {
			...
			DISCIPLINARY_CONTROL: 'Disciplinary Control',
