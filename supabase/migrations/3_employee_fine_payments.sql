-- Migration: Create employee_fine_payments table
-- File: 3_employee_fine_payments.sql
-- Description: Creates the employee_fine_payments table for managing fine payment records
