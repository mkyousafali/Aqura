-- User Device Sessions Schema
-- This table manages user authentication sessions across different devices
...
CREATE TRIGGER trigger_user_device_sessions_updated_at BEFORE UPDATE ON user_device_sessions FOR EACH ROW
