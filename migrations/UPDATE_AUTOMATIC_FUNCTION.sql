-- ============================================================================
-- UPDATE AUTOMATIC FUNCTION TO LATEST VERSION
-- ============================================================================
-- This will replace the old function with the corrected version
-- ============================================================================

-- Drop the old function
DROP FUNCTION IF EXISTS check_overdue_tasks_and_send_reminders();

-- Recreate with correct column mappings
...
-- Add comment
COMMENT ON FUNCTION check_overdue_tasks_and_send_reminders() IS 'Checks for overdue tasks and sends automatic reminders via notifications. Updated with correct notification column mapping.';
