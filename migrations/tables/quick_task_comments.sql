-- Migration for table: quick_task_comments
-- Generated on: 2025-10-30T21:55:45.286Z
...
CREATE TRIGGER set_quick_task_comments_updated_at
    BEFORE UPDATE ON public.quick_task_comments
    FOR EACH ROW
