-- Migration for table: hr_salary_wages
-- Generated on: 2025-10-30T21:55:45.328Z
...
CREATE TRIGGER set_hr_salary_wages_updated_at
    BEFORE UPDATE ON public.hr_salary_wages
    FOR EACH ROW
