-- FINAL SOLUTION: Create the one and only create_task function
-- Database is now clean, creating exactly what we need
...
-- Update generate_clearance_certificate_tasks to use the function
