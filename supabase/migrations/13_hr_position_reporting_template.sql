-- Migration: Create hr_position_reporting_template table
-- File: 13_hr_position_reporting_template.sql
-- Description: Creates the hr_position_reporting_template table for managing hierarchical reporting structures
