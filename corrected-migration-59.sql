-- CORRECTED Migration 59: Auto Payment Transaction and Task Creation
-- This fixes the user assignment logic to work with the actual database structure
...
-- Create corrected function with proper user finding logic
...
COMMENT ON FUNCTION auto_create_payment_transaction_and_task() IS 'Automatically creates payment transaction record and task when payment is marked as paid - CORRECTED VERSION with proper user assignment';
