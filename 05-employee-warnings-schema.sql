-- Employee Warnings Schema
-- Manages employee warnings, disciplinary actions, and fines
...
AFTER INSERT OR DELETE OR UPDATE ON employee_warnings FOR EACH ROW
...
CREATE TRIGGER trigger_sync_fine_paid_columns BEFORE INSERT OR UPDATE ON employee_warnings FOR EACH ROW
EXECUTE FUNCTION sync_fine_paid_columns();

CREATE TRIGGER trigger_update_warning_updated_at BEFORE UPDATE ON employee_warnings FOR EACH ROW
